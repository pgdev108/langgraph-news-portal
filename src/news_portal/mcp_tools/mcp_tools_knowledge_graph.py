#!/usr/bin/env python3
"""
Knowledge Graph Builder MCP Tool
================================

Tool for building domain-specific knowledge graphs from documents using LLM + graph theory.
"""
...
class KnowledgeGraphBuilderTool(BaseMCPTool):
    """MCP Tool for building knowledge graphs from domain documents."""
